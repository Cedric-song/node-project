...
!function($) {
    ...
    $.extend($.fn.bootstrapTable.locales, {
        formatAdvancedSearch: function() {
            ...
            return '<center style="font-weiht:bold">过滤条件</center>';
        },
    ...
    BootstrapTable.prototype.initToolbar = function() {
        ...
        html.push(sprintf('<button class="btn btn-default%s' + '" type="button" name="advancedSearch" title="">过滤条件', that.options.iconSize === undefined ? '' : ' btn-' + that.options.iconSize));
